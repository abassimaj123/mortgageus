...
void main() {
  ...
  group('PMI auto-cancel at 78% LTV (HPA)', () {
    test(
        'PMI drops when balance reaches 78% of home price (month ~109, index 108)',
        () {
    ...
    test('PMI drop month balance is ≤ 78% of home price', () {
      ...
      expect(dropEntry.balance / 500000,
          lessThanOrEqualTo(MortgageConstants.pmiAutoCancelLtv));
    });
