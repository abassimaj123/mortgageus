...
void main() {
  ...
  group('calcAffordability — price ordering', () {
    test('AF3: standard >= conservative when monthly debts = 0', () {
      ...
      expect(r.maxHomePriceStandard,
          greaterThanOrEqualTo(r.maxHomePriceConservative));
    });
  ...
  group('calcAffordability — monthly debts impact', () {
    ...
    test(
        'AF8: debts do NOT affect conservative price (28% front-end DTI is PITI only)',
        () {
  ...
  group('calcAffordability — loan amounts', () {
    test('AF12: maxLoanStandard ≈ maxHomePriceStandard - downPayment', () {
      ...
      expect(r.maxLoanStandard, closeTo(r.maxHomePriceStandard - 60000, 1.0));
    });
  ...
  group('calcAffordability — income scaling', () {
    test('AF14: doubling income approximately doubles max home price', () {
      ...
      expect(
          r2.maxHomePriceStandard, greaterThan(r1.maxHomePriceStandard * 1.6));
    });

    test(
        'AF15: 15yr term → lower max home price than 30yr (higher monthly P&I)',
        () {
