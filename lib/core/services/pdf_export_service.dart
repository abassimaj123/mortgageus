...
class PdfExportService {
  static final _usd2 = NumberFormat.currency(locale: 'en_US', symbol: '\$', decimalDigits: 2);
  static final _usd0 = NumberFormat.currency(locale: 'en_US', symbol: '\$', decimalDigits: 0);
  ...
  static pw.Widget _buildSummaryPage(MortgageInputState input, MortgageResult result) {
          ...
          children: [
            ...
            pw.Expanded(child: pw.Column(children: [
              _sectionBox('LOAN DETAILS', [
                ...
                _row2('Interest Rate','${input.annualRatePct.toStringAsFixed(2)}%'),
                _row2('Loan Term',    '${input.termYears} years'),
                _row2('Loan Type',    input.loanType.label),
                _row2('LTV',          '${result.currentLtv.toStringAsFixed(1)}%'),
                if (result.isJumbo) _row2('Classification', 'JUMBO LOAN', highlight: true),
              ]),
              pw.SizedBox(height: 10),
              _sectionBox('TOTAL COST', [
                _row2('Total Interest', _usd0.format(result.totalInterest), highlight: false),
                _row2('Total Cost',     _usd0.format(result.totalCost),     bold: true),
                _row2('Payoff Date',    DateFormat('MMM yyyy').format(result.payoffDate)),
              ]),
              if (result.hasPmi) ...[
                pw.SizedBox(height: 10),
                _sectionBox('PMI', [
                  _row2('Monthly PMI',   _usd2.format(result.monthly.pmi)),
                  _row2('PMI Drops at', result.pmiDropMonth != null
            ...
            pw.Expanded(child: pw.Column(children: [
              _sectionBox('MONTHLY BREAKDOWN', [
                _row2('P & I',         _usd2.format(result.monthly.piPayment), bold: true, color: _navy),
                ...
                _row2('Home Insurance',_usd2.format(result.monthly.homeInsurance)),
    ...
    return _sectionBox('PRINCIPAL vs INTEREST', [
      ...
      pw.Row(children: [
        ...
        pw.Expanded(
          ...
          child: pw.Container(height: 14, color: _gold,
            child: pw.Center(child: pw.Text(
  ...
  static List<pw.Widget> _buildYearlySection(MortgageResult result) {
    ...
    return [
      ...
      pw.TableHelper.fromTextArray(
        headers: ['Year', 'Total Pmt', 'Principal', 'Interest', 'Balance', 'Cum. Interest'],
        data: yearlyData,
  ...
  static List<pw.Widget> _buildMonthlySection(MortgageResult result) {
    final rows = result.schedule.map((e) => [
      e.month.toString(),
    ...
    return [
      ...
      pw.SizedBox(height: 6),
      pw.TableHelper.fromTextArray(
        headers: ['Mo.', 'Date', 'Payment', 'Principal', 'Interest', 'PMI', 'Balance', 'Cum. Int.'],
        data: rows,
        headerStyle: pw.TextStyle(
  ...
  static pw.Widget _amortHeader(MortgageInputState input, MortgageResult result, int page) =>
      pw.Container(
        ...
        children: [
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            isEs ? 'Exportar una vez — gratis' : 'Export once — free',
                            style: TextStyle(
          ...
          SizedBox(
            ...
            child: ElevatedButton.icon(
              ...
              label: Text(
                isEs ? 'Premium — \$4.99 (ilimitado)' : 'Premium — \$4.99 (unlimited)',
